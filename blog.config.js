...
const BLOG = {
  ...
  THEME: process.env.NEXT_PUBLIC_THEME || ['hexo',"fukasawa','medium','example']// 主题， 支持 ['next','hexo',"fukasawa','medium','example','matery','gitbook','simple'] @see https://preview.tangly1024.com
